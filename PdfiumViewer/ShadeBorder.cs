...
namespace PdfiumViewer
{
  internal class ShadeBorder : IDisposable
  {
    ...
    private TextureBrush _e = new TextureBrush(Resources.ShadeBorder_E, WrapMode.Tile);
    private TextureBrush _n = new TextureBrush(Resources.ShadeBorder_N, WrapMode.Tile);
    private Image _ne = Resources.ShadeBorder_NE;
    private Image _nw = Resources.ShadeBorder_NW;
    private TextureBrush _s = new TextureBrush(Resources.ShadeBorder_S, WrapMode.Tile);
    private Image _se = Resources.ShadeBorder_SE;
    private Image _sw = Resources.ShadeBorder_SW;
    private TextureBrush _w = new TextureBrush(Resources.ShadeBorder_W, WrapMode.Tile);
